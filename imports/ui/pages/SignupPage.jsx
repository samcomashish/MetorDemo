...
export default class SignupPage extends Component {
  ...
  handleSubmit(e){
    ...
    let confirmPassword = document.getElementById("signup-password").value;
    this.setState({error: "SignUp Sucessfuly"});
    Accounts.createUser({email: email, password: password, confirmPassword: confirmPassword}, (err) => {
      if(err){
        this.setState({
          error: err.reason
        });
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <form id="login-form" className="form col-md-12 center-block" onSubmit={this.handleSubmit}>
                ...
                <div className="form-group">
                  <input type="password" id="signup-confirmPassword" className="form-control input-lg" placeholder="confirm password"/>
                </div>
                <div className="form-group">
